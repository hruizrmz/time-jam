...
label sc03b_main:
    ...
    n "It had been about a year since his visit to one of England's biggest boutiques, along with his now fiancée."
    nvl clear
    ...
    n "Nevertheless, Benjamin remembered without a doubt the location of the perfumery department. After twenty minutes, he had arrived."
    window hide
    nvl clear
    ...
    cl "He's a middle-aged man that is always wearing a blue raincoat."
    cl "Lately it's more of a dark green if you ask me... It's been drenched in nothing but rubbish."
    ...
    cl "That bloody man always reeks of alcohol. Given his messy appearance as of late, I'd say you can find him at a bar."
    ...
    n "The young lawyer had always kept this mantra close to his heart, and it had taken him thus far."
